...
sbatch --time=3:59:59 --tmp=1024 --gpus=1 --mem-per-cpu=10g --gres=gpumem:10g  --account=es_yang --wrap="srun python experiments/post_processing/eval_statistics_bench.py --project_name private_gsd   --metrics wdist_1_2Way"
sbatch --time=3:59:59 --tmp=1024  --mem-per-cpu=10g --account=es_yang --wrap="srun python experiments/post_processing/eval_statistics_bench.py --project_name  private_gsd  --metrics newl1_2Way"
...
sbatch --time=23:59:59 --tmp=1024 --cpus-per-task=10 --mem-per-cpu=10g --account=es_yang --wrap="srun python experiments/post_processing/eval_downstream_bench.py --project_name private_gsd"
