...
for epsilon in epsilons:
    ...
    for plot_stat in statistics.keys():
        ...
        # Save the current statistic plot
        os.makedirs(os.path.join(script_folder, f"plots_paper/{epsilon}/"), exist_ok=True)
        filename = os.path.join(script_folder, f'plots_paper/{epsilon}/{plot_stat}.pdf')
        plt.savefig(filename)
        filename = os.path.join(script_folder, f'plots_paper/{epsilon}/{plot_stat}.png')
        plt.savefig(filename)  
        plt.close()
